    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Tambah Pembuat Soal</h3>
                <p class="text-subtitle text-muted">Daftarkan akun guru baru untuk membuat soal ujian.</p>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="alert alert-light-info text-sm py-2 mb-2"><i class="bi bi-info-circle"></i> Pilih mapel yang boleh dibuat soalnya oleh user ini.</div>
