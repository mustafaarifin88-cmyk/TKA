    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Edit Sekolah</h3>
                <p class="text-subtitle text-muted">Perbarui informasi data sekolah.</p>
            </div>
                ...
                <form action="<?= base_url('admin/sekolah/update/' . $sekolah['id']) ?>" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <input type="text" name="kecamatan" class="form-control" value="<?= old('kecamatan', $sekolah['kecamatan']) ?>" required>
                        </div>
                    </div>
