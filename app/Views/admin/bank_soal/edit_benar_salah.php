    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Koreksi soal tipe pernyataan benar atau salah majemuk.</p>
            </div>
        ...
        <div class="card shadow-sm border-0 mb-4">
            ...
            <div class="card-body pt-4">
                        ...
                        <?php if ($soal['file_soal']) : ?>
                            <div class="text-center p-2 border rounded bg-light">
                                <img src="<?= base_url('uploads/bank_soal/' . $soal['file_soal']) ?>" 
                                     height="100" class="img-fluid rounded" 
                ...
                <div class="d-flex justify-content-end gap-2 mt-5">
                    <a href="<?= base_url("admin/bank_soal/list/{$soal['guru_id']}/{$soal['mapel_id']}") ?>" class="btn btn-light-secondary">Batal</a>
                    <button type="submit" class="btn btn-primary px-4 shadow"><i class="bi bi-save me-2"></i> Simpan Perubahan (Admin)</button>
                </div>
            </div>
        </div>
    </form>
